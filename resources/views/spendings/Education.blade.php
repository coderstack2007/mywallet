...
<div class="houselist">
<h1>Education expenses</h1>

<ul class="ul">
    
    <button  style="background-color: transparent;" onclick="document.getElementById('myModal').style.display='block'"><li class="li">Emaktab</li></button>

    <button  style="background-color: transparent;" onclick="document.getElementById('myModal2').style.display='block'"><li class="li">English course</li></button>
</ul class="ul">
...
<div style="display: flex; flex-direction: column; align-items: center; background-color: #fefefe; padding: 20px; border: 1px solid #888; width: 80%; max-width: 400px; height: 400px; " >
    ...
    <input type="hidden" name="type" value="emaktab" >
    <input type="hidden" name="expenture" value="education" >
