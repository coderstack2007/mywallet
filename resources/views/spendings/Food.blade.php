...
<div class="houselist">
<h1>Food and Drinks expenses</h1>

<ul class="ul">
    
    <button  style="background-color: transparent;" onclick="document.getElementById('myModal').style.display='block'"><li class="li">Food</li></button>

    <button  style="background-color: transparent;" onclick="document.getElementById('myModal2').style.display='block'"><li class="li">Drinks</li></button>
</ul class="ul">
...
<div style="display: flex; flex-direction: column; align-items: center; background-color: #fefefe; padding: 20px; border: 1px solid #888; width: 80%; max-width: 400px; height: 400px; " >
    ...
    <input type="hidden" name="expenture" value="Foods" >
