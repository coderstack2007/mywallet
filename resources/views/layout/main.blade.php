    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Addings</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>Additional income</span>
            </a>
          </li>
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>Gifts</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Credits</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Spendings</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('foodanddrinks') }}">
              <i class="bi bi-circle"></i><span>Food and Drinks</span>
            </a>
          </li>
          <li>
            <a href="{{ route('house') }}">
              <i class="bi bi-circle"></i><span>House</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="charts-echarts.html">
              <i class="bi bi-circle"></i><span>Healthcare</span>
            </a>
          </li>
        </ul>
      </li>
